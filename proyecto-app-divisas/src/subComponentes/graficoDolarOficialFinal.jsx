                ...
                <section className='flex flex-col justify-center align-middle mt-12'>
                    <article className='flex flex-row justify-around'>
                        <motion.div whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.8 }} >
                            <button onClick={fetchDolarOficial6Month} className='w-24 h-8 font-[Roboto] text-base  bg-color-2 shadow-md shadow-black rounded-xl'>6 meses</button>
                        </motion.div>
                        <motion.div whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.8 }} >
                            <button onClick={getDolarOficial1year} className='w-24 h-8 font-[Roboto] text-base  bg-color-2 shadow-md shadow-black rounded-xl'>1 año</button>
                        </motion.div>
                        <motion.div whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.8 }} >
                            <button onClick={getDolarOficial5years} className='w-24 h-8 font-[Roboto] text-base  bg-color-2 shadow-md shadow-black rounded-xl'>5 años</button>
                        </motion.div>
                    </article>
                    <article className='flex flex-col justify-center align-middle mt-6'>
                        <article className='flex flex-row justify-around align-middle'>
                            <div className='flex flex-col w-2/3'>
                                ...
                                <input value={desde} onChange={setFechaUno} className='w-full h-10 p-2 outline outline-1 outline-gray-500 rounded-lg text-center' type="date" name="input-desde" id="input-desde" />
                            </div>
                            <motion.div style={{ display: 'flex', justifyContent: 'center', alignContent: 'center' }} whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.8 }} >
                                <button onClick={setGrafico} className='my-auto mt-7 w-20 h-8 text-base rounded-xl bg-color-2 shadow-md shadow-black' >Cargar</button>
                            </motion.div>
                        </article>
                        <article className='flex flex-row justify-around align-middle mt-6'>
                            <div className='flex flex-col w-2/3'>
                                ...
                                <input value={hasta} onChange={setFechaDos} className='w-full h-10 p-2 outline outline-1 outline-gray-500 rounded-lg text-center' type="date" name="input-hasta" id="input-hasta" />
                            </div>
